...
model_cards = {
  ...
  "llama-3.3-70b": {
    ...
    "repo": {
       ...
       "PyTorchDynamicShardInferenceEngine": "unsloth/Llama-3.3-70B-Instruct",
    },
  },
  "llama-3.2-1b": {
    "layers": 16,
    "repo": {
      ...
      "PyTorchDynamicShardInferenceEngine": "unsloth/Llama-3.2-1B-Instruct",
    },
  },
  "llama-3.2-1b-8bit": {
    "layers": 16,
  ...
  "llama-3.2-3b": {
    ...
    "repo": {
       ...
       "PyTorchDynamicShardInferenceEngine": "unsloth/Llama-3.2-3B-Instruct",
    },
  },
  "llama-3.2-3b-8bit": {
    "layers": 28,
  ...
  "llama-3.1-8b": {
    ...
    "repo": {
       ...
       "PyTorchDynamicShardInferenceEngine": "mlabonne/Meta-Llama-3.1-8B-Instruct-abliterated",
    },
  },
  "llama-3.1-70b": {
    "layers": 80,
    "repo": {
       ...
       "PyTorchDynamicShardInferenceEngine": "NousResearch/Meta-Llama-3.1-70B-Instruct",
    },
  },
  "llama-3.1-70b-bf16": {
    "layers": 80,
  ...
  "llama-3-8b": {
    ...
    "repo": {
       ...
       "PyTorchDynamicShardInferenceEngine": "TriAiExperiments/SFR-Iterative-DPO-LLaMA-3-8B-R",
    },
  },
  ...
  "mistral-nemo": { 
    ...
    "repo": { 
      ...
      "PyTorchDynamicShardInferenceEngine": "HuggingFaceH4/mistral-7b-sft-beta", 
    }, 
  },
  "mistral-large": { 
    "layers": 88, 
    "repo": { 
      ...
      "PyTorchDynamicShardInferenceEngine": "microsoft/Phi-3.5-mini-instruct", 
    }, 
  },
  ### deepseek
  ...
  "phi-4": { 
    ...
    "repo": { 
      ...
      "PyTorchDynamicShardInferenceEngine": "microsoft/phi-4",  
    }, 
  },
  # dummy
